Spree::OrdersController.class_eval do
  ...
  def add_subscription(variant_id, interval_id)
    ...
    if line_item.subscription
      line_item.subscription.update_attributes :times => interval.times, :time_unit => interval.time_unit, time_length: interval.time_length, time_unit_length: interval.time_unit_length, line_item_id: line_item.id
    else
